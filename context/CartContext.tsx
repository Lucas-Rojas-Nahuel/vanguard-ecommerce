...
interface CartContextType {
  ...
  decreaseQuantity: (id: string) => void; // 👈 1. Agregamos la definición
...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  // 4. Función para disminuir la cantidad de un producto
  const decreaseQuantity = (id: string) => {
    setCart((prevCart) => {
      ...
      // Si le queda solo 1, al restar lo removemos por completo del carrito
  ...
  // 5. Función para remover un producto completo
