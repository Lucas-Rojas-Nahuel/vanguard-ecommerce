...
import AddToCartButton from "@/components/shop/AddToCartButton"; // Importa el nuevo componente
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-50 p-6 sm:p-10">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Link
          href="/"
          className="text-sm text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100 transition inline-flex items-center gap-1"
        >
          ← Volver al catálogo
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white dark:bg-neutral-900 p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm items-center">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <span
                className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold ${product.stock > 0 ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400" : "bg-red-50 text-red-700 dark:bg-red-950/30 dark:text-red-400"}`}
              >
                {product.stock > 0
                  ? `Stock Disponible: ${product.stock} u`
                  : "Agotado"}
              </span>
